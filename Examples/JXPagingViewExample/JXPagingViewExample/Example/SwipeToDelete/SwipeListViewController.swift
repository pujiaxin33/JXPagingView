...
class SwipeListViewController: UIViewController {
...
extension SwipeListViewController: UITableViewDataSource, UITableViewDelegate {
    public func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return dataSource.count
    }

    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "cell", for: indexPath) as? SwipeCell ?? SwipeCell()
...
extension SwipeListViewController: JXPagingViewListViewDelegate {
